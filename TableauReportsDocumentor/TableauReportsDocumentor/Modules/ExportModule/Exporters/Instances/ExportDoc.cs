 ...
 * Class: ExportDoc
 * 
 * Exporter class implementing ExportInterface that transforms our TRD xml file into a complete .doc document.
 * It uses a DocX library to accomplish it's task.
 * 
 * Code here is mostly corresponding to the code in Docx exporter.
 * 
 * Used libraries:
 *  Library: DocX
 *  Version: 1.0.0.15
...
{
    class ExportDoc : ExportInterface
    {
        /*
        ...
        public BitmapFrame MenuItemIcone
        {
            ...
            {
                return null;
                //Uri iconUri = new Uri("doc.ico", UriKind.RelativeOrAbsolute);
        ...
        {
            get { return "Doc document|*.doc"; }
        }

        /*
         * Function Export
         * Main function of the class. Performs the export process of our TRD xml into a .doc file
         * 
         * Parameters:
